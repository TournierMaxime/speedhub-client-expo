...
const privacyPolicyData: PrivacyPolicyProps[] = [
  ...
  },
  {
    ...
    content: [
      ...
      "Application refers to SpeedHub, the software program provided by the Company.",
      'Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to SpeedHub.',
  ...
  },
  {
    ...
    content: [
      ...
      "By visiting this page on our website: https://speedrunfrance.fr",
    ],
  },
]
    ...
    <ScrollView style={mainStyle.container}>
      ...
      >
        {privacyPolicyData.map((section, idx) => {
          return (
            <View style={privacyPolicyStyle.container} key={idx}>
              <Text style={privacyPolicyStyle.title}>{section.title}</Text>
              {section.content.map((paragraph, idx) => {
                return (
                  <Text key={idx} style={privacyPolicyStyle.content}>
                    {paragraph}
                  </Text>
                )
              })}

    ...
    const renderItem = ({ item }: { item: any }) => {
        switch (selectedOptionValue) {
            case "games":
                return (
                    <TouchableOpacity
                        style={[style.card, theme == "dark" ? { backgroundColor: Colors.dark.background } : { backgroundColor: Colors.light.background }]}
                        onPress={async () =>
                    ...
                    >
                        ...
                        <View>
                            <Entypo name="chevron-right" size={Utils.moderateScale(24)} color={theme == "dark" ? Colors.dark.icon : Colors.light.icon} />
                        </View>
                    </TouchableOpacity>
                )
            default:
